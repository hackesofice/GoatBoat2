...
},
{
  ...
  if (!content) return out("Vui lòng nhập phép tính");
    ...
    try {
      ...
      var data = (await axios.get(`http://api.wolframalpha.com/v2/query?appid=T8J8YV-H265UQ762K&input=${encodeURIComponent(content)}&output=json`)).data;
