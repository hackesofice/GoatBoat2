...
module.exports = {
	...
	langs: {
		...
		en: {
			antiChangeAvatarOn: "Turn on lock avatar box chat",
			antiChangeAvatarOff: "Turn off lock avatar box chat",
			missingAvt: "You have not set avatar for box chat",
			antiChangeNameOn: "Turn on lock name box chat",
			antiChangeNameOff: "Turn off lock name box chat",
			antiChangeNicknameOn: "Turn on lock nickname box chat",
			antiChangeNicknameOff: "Turn off lock nickname box chat",
			antiChangeThemeOn: "Turn on lock theme box chat",
			antiChangeThemeOff: "Turn off lock theme box chat",
			antiChangeEmojiOn: "Turn on lock emoji box chat",
			antiChangeEmojiOff: "Turn off lock emoji box chat",
			antiChangeAvatarAlreadyOn: "Your box chat is currently on lock avatar",
			antiChangeNameAlreadyOn: "Your box chat is currently on lock name",
			antiChangeNicknameAlreadyOn: "",
			antiChangeThemeAlreadyOn: "Your box chat is currently on lock theme",
			antiChangeEmojiAlreadyOn: "Your box chat is currently on lock emoji"
		}
	},
	...
	if(api.getCurrentUserID() !== author) {					//message.reply(getLang("antiChangeNicknameAlreadyOn"));
